const Intro = () => {
  return (
    <section className="container relative">
      <p className="font-roboto font-medium text-xl w-5/12 mb-16">
      ...
      <div className="flex justify-between mb-48">
        <div className="w-5/12 text-base font-thin font-roboto">
          <img src="images/intro/intro-1.jpg" alt="intro" />
          <h4 className="text-xl font-roboto my-5 font-semibold">
        ...
        <div className="w-5/12 text-base -mt-16">
